from eugeo import tbot, ubot, CMD_HELP
...
async def _(event):
    ...
    packname = f"{first_name}'s Eugeo Kang Vol.{pack}"
    packshortname = f"{userid}'s_Eugeo_Pack"
    kanga = await event.reply("`Kanging .`")
    is_a_s = is_it_animated_sticker(reply_message)
    file_ext_ns_ion = "@EugeoRobot.png"
    ...
    if is_a_s:
        ...
        packname = f"{first_name}'s Animated EugeoKang Vol.{pack}"
        packshortname = f"Eugeo_animate_{userid}"
    ...
    os.system("rm -rf  @EugeoRobot.png")
...
__help__ = """
 ...
 - /delsticker: remove a sticker from your current personal sticker pack
