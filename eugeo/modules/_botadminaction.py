from eugeo import tbot, OWNER_ID, DEV_USERS
from eugeo import MONGO_DB_URI, BOT_ID, GBAN_LOGS
from pymongo import MongoClient
from eugeo.function import is_admin, sudo
from telethon import events
from eugeo.events import register
from telethon.tl.functions.users import GetFullUserRequest

from eugeo.modules.sql.chats_sql import get_all_chat_id
...
async def gban(event):
 ...
 if r_sender_id == OWNER_ID:
        ...
        await event.reply("That's a Sudo User")
        return
 chats = gbanned.find({})
 for c in chats:
