...
from eugeo.modules.sql.setbio_sql import set_bio, rm_bio
from eugeo.modules.sql.setbio_sql import SUDO_USERS as boss
from eugeo import tbot, OWNER_ID, CMD_HELP, ubot, StartTime, MONGO_DB_URI, BOT_ID
import datetime, time
from eugeo.function import is_admin, bio
...
@register(pattern="^/(ping|ping@EugeoRobot)")
...
async def gey(event):
   ...
   async with tbot.conversation("@roseloverx") as bot_conv:
      ...
      await (await inline_query(ubot, "@HowGayBot", k))[0].click("@eugeoRobot")
 ...
 try:
    ...
    async with ubot.conversation(chat) as conv:
        try:
            ...
            await stt.edit("Error, Report at @eugeoSupport")
            return
