...
from eugeo import CMD_LIST, LOAD_PLUG, tbot
import glob
import sys
from eugeo import ubot
from pymongo import MongoClient
from eugeo import MONGO_DB_URI
from eugeo.modules.sql.checkuser_sql import add_usersid_in_db, already_added, get_all_users
...
def load_module(shortname):
    if shortname.startswith("__"):
        ...
        path = Path(f"eugeo/modules/{shortname}.py")
        name = "eugeo.modules.{}".format(shortname)
        ...
        mod.eugeorobot = eugeorobot
        mod.tbot = tbot
        mod.logger = logging.getLogger(shortname)
        spec.loader.exec_module(mod)
        sys.modules["eugeo.modules." + shortname] = mod
        print("Successfully imported " + shortname)


path = "eugeo/modules/*.py"
